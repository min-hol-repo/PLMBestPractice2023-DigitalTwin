...
![그림 1 - 디지털 트윈의 진화](media/kr_image4.png)
...
![그림 2 - 온톨로지 중심의 디지털 피드백 순환](media/kr_image7.png)
...
![그림 3 - 산업별 공용 온톨로지 템플릿](media/kr_image6.png)
...
![그림 4 - NVIDIA Omniverse on Azure](media/kr_image3.png)
...
![그림 5 - 클라우드 기반의 단계별 디지털 트윈 구현 예시](media/kr_image2.png)
...
![그림 6 - 사용 요건에 따른 다양한 Azure HPC 클라우드 서비스](media/kr_image5.png)
